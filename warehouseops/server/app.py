...
"""
FastAPI application for the Warehouseops Environment.

This module creates an HTTP server that exposes the WarehouseopsEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m warehouseops.server.app
    ...
    multiple workers:
        uvicorn warehouseops.server.app:app --workers 4
    """
    import uvicorn
